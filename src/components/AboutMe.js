      ...
      <Container fluid className="home-about-me-container" id="aboutme">
        ...
        <Row className="home-about-me-content-container">
          ...
          <Col md={true} className="home-about-me-content-two">
            <p className="home-about-me-text secondary">Hey there! I'm Jo Sumbuddy, a software developer based in Manhattan, NYC. I work with some of the popular front-end tech to create beautiful websites that get noticed. I'm seeking experience to gain more knowledge in the web development field.</p>
          </Col>
        </Row>
      </Container>
    );
